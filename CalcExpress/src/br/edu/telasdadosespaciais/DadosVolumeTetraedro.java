 ...
 * @author Andre
 */
public class DadosVolumeTetraedro extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosVolumeTetraedro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(VolumeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 100, 40));
        getContentPane().add(VolumeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 280, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/TetraedroVolumeDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
        ...
        if ((((Double.parseDouble(ArestaBaseText.getText() ))) > 0)) { 
            ...
            VolumeText.setText(String.format("%.2f", tetra.getVolume()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosVolumeTetraedro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosVolumeTetraedro().setVisible(true);
            }
        });
    }
