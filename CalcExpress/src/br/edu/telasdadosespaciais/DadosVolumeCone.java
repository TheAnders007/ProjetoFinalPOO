 ...
 * @author Andre
 */
public class DadosVolumeCone extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaLateralCilindro
     */
    public DadosVolumeCone() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/ConeVolumeDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
           ...
           if ((((Double.parseDouble(RaioText.getText() ))) > 0) && ((Double.parseDouble(AlturaText.getText() )) > 0)) { 
            ...
            VolumeText.setText(String.format("%.2f", cone.getVolume()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosVolumeCone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosVolumeCone().setVisible(true);
            }
        });
    }
