 ...
 * @author Andre
 */
public class DadosAreaLateralPrisma extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosAreaLateralPrisma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(AreaLateralLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 100, 40));
        getContentPane().add(AreaLateralText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 280, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/PrismaAreaLateralDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
           ...
           if (((Double.parseDouble(ArestaBaseText.getText() )) > 0) && ((Double.parseDouble(ArestaLateralText.getText() )) > 0))  {
            ...
            prism.calcAreaLateral();
            AreaLateralLabel.setVisible(true);
            AreaLateralText.setText(String.format("%.2f", prism.getAreaLateral()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaLateralPrisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaLateralPrisma().setVisible(true);
            }
        });
    }
