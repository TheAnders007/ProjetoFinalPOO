 ...
 * @author Andre
 */
public class DadosAreaBasePrisma extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosAreaBasePrisma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(AreaBaseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 100, 40));
        getContentPane().add(AreaBaseText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 280, -1));

        jLabel1.setForeground(new java.awt.Color(255, 204, 102));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/PrismaAreaBaseDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            AreaBaseText.setText(String.format("%.2f", prism.getAreaBase()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaBasePrisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaBasePrisma().setVisible(true);
            }
        });
    }
