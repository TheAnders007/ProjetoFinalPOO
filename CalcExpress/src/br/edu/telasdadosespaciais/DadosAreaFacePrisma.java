...
public class DadosAreaFacePrisma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AreaFaceLabel = new javax.swing.JLabel();
        AreaFaceText = new javax.swing.JTextField();
        ...
        jLabel2.setText("Aresta Lateral");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 100, 40));
        ...
        AreaFaceLabel.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        AreaFaceLabel.setForeground(new java.awt.Color(153, 0, 0));
        AreaFaceLabel.setText("Área da Face");
        getContentPane().add(AreaFaceLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 100, 40));
        getContentPane().add(AreaFaceText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 280, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 0, 0));
        jLabel3.setText("Aresta da Base");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 100, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/PrismaAreaFaceDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            prism.calcAreaFace();
            AreaFaceLabel.setVisible(true);
            AreaFaceText.setText(String.format("%.2f", prism.getAreaFace()));
            AreaFaceText.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaFacePrisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaFacePrisma().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel AreaFaceLabel;
    private javax.swing.JTextField AreaFaceText;
