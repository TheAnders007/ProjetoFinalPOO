...
public class DadosAreaTotalCubo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AreaTotalText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AreaTotalTextActionPerformed(evt);
            }
        });
        getContentPane().add(AreaTotalText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, 320, -1));
        ...
        getContentPane().add(AreaTotalLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 80, 40));
        ...
        getContentPane().add(LadoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 320, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/CuboAreaTotalDados.png"))); // NOI18N
    ...
    private void AreaTotalTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AreaTotalTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AreaTotalTextActionPerformed
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
       ...
       if ((Double.parseDouble(LadoText.getText())) > 0) { 
        ...
        AreaTotalText.setText(String.format("%.2f", cubo.getAreaTotal()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaTotalCubo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaTotalCubo().setVisible(true);
            }
        });
    }
