 ...
 * @author Andre
 */
public class DadosAreaLateralCilindro extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaLateralCilindro
     */
    public DadosAreaLateralCilindro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/CilindroAreaLateralDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            JOptionPane.showMessageDialog(null, "Não digite letras.");
             ...
             if ((((Double.parseDouble(RaioText.getText() ))) > 0) && ((Double.parseDouble(AlturaText.getText() )) > 0)) { 
               ...
               cilin.calcAreaLateral();
        
         AreaLateralLabel.setVisible(true);
         AreaLateralText.setText(String.format("%.2f", cilin.getAreaLateral()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaLateralCilindro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaLateralCilindro().setVisible(true);
            }
        });
    }
