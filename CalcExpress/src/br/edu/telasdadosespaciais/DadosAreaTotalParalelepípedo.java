 ...
 * @author Andre
 */
public class DadosAreaTotalParalelepípedo extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaLateralCilindro
     */
    public DadosAreaTotalParalelepípedo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(AreaTotalText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 320, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/ParalelepípedoAreaTotalDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            parallp.calcAreaTotal();
            AreaTotalLabel.setVisible(true);
            AreaTotalText.setText(String.format("%.2f", parallp.getAreaTotal()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaTotalParalelepípedo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaTotalParalelepípedo().setVisible(true);
            }
        });
    }
