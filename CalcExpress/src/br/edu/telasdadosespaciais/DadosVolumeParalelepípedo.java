 ...
 * @author Andre
 */
public class DadosVolumeParalelepípedo extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaLateralCilindro
     */
    public DadosVolumeParalelepípedo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(VolumeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 320, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/ParalelepípedoVolumeDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            VolumeText.setText(String.format("%.2f", parallp.getVolume()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosVolumeParalelepípedo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosVolumeParalelepípedo().setVisible(true);
            }
        });
    }
