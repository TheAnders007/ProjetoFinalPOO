...
import br.edu.escolhas.TipoCalculoCone;
 ...
 * @author Andre
 */
public class DadosAreaLateralCone extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaLateralCilindro
     */
    public DadosAreaLateralCone() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(AlturaText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 210, 320, -1));
        ...
        getContentPane().add(RaioText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 320, -1));
        ...
        getContentPane().add(AreaLateralLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 100, 40));
        getContentPane().add(AreaLateralText, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 320, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/ConeAreaLateralDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
           ...
           if ((((Double.parseDouble(RaioText.getText() ))) > 0) && ((Double.parseDouble(AlturaText.getText() )) > 0)) { 
            Cone cone = new Cone();
            cone.setRaio(Double.parseDouble(RaioText.getText()));
            cone.setAltura(Double.parseDouble(AlturaText.getText()));
            cone.calcAreaLateral();
            AreaLateralLabel.setVisible(true);
            AreaLateralText.setText(String.format("%.2f", cone.getAreaLateral()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaLateralCone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaLateralCone().setVisible(true);
            }
        });
    }
