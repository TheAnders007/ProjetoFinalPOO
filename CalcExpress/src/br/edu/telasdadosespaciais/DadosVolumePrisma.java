 ...
 * @author Andre
 */
public class DadosVolumePrisma extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosVolumePrisma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(VolumeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 100, 40));
        getContentPane().add(VolumeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 280, -1));
        ...
        getContentPane().add(AlturaText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 280, -1));
        ...
        getContentPane().add(AlturaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 100, 40));

        jLabel1.setForeground(new java.awt.Color(255, 204, 102));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/PrismaVolumeDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            prism.setAltura(Double.parseDouble(AlturaText.getText()));
            prism.calcVolume();
            VolumeLabel.setVisible(true);
            VolumeText.setText(String.format("%.2f", prism.getVolume()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosVolumePrisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosVolumePrisma().setVisible(true);
            }
        });
    }
