 ...
 * @author Andre
 */
public class DadosAreaTotalPiramide extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosAreaTotalPiramide() {
        initComponents();
    ...
    private void initComponents() {
        ...
        ApotemaText = new javax.swing.JTextField();
        ...
        ApotemaText.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ApotemaTextMouseClicked(evt);
            }
        });
        getContentPane().add(ApotemaText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, 300, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 0, 51));
        jLabel3.setText("Apótema");
        ...
        getContentPane().add(AreaTotalText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 300, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/PirâmideAreaTotalDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
            ...
            if (ApotemaText.getText().trim().equals("")){
                ApotemaText.setText("Campo Vazio");
            }
            else if (Double.parseDouble(ApotemaText.getText()) <= 0){
                ApotemaText.setText("Valor Não Aceito");
            }
             } catch (NumberFormatException e){
            JOptionPane.showMessageDialog(null, "Não digite letras.");
        }
            
         if ((((Double.parseDouble(ArestaBaseText.getText() ))) > 0) && ((Double.parseDouble(ApotemaText.getText() )) > 0)) { 
            Piramide piram = new Piramide();
            piram.setArestaBase(Double.parseDouble(ArestaBaseText.getText()));
            piram.setApotema(Double.parseDouble(ApotemaText.getText()));
            piram.calcAreaTotal();
            AreaTotalLabel.setVisible(true);
            AreaTotalText.setText(String.format("%.2f", piram.getAreaTotal()));
    ...
    private void ApotemaTextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApotemaTextMouseClicked
        if ((ApotemaText.getText().equals("Campo Vazio")) || (ApotemaText.getText().equals("Valor Não Aceito"))){
                   ApotemaText.setText("");
        }
    }//GEN-LAST:event_ApotemaTextMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaTotalPiramide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaTotalPiramide().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField ApotemaText;
