...
public class DadosVolumeCubo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(LadoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 320, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/CuboVolumeDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
       ...
       if ((Double.parseDouble(LadoText.getText())) > 0) { 
        ...
        VolumeText.setText(String.format("%.2f", cubo.getVolume()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosVolumeCubo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosVolumeCubo().setVisible(true);
            }
        });
    }
