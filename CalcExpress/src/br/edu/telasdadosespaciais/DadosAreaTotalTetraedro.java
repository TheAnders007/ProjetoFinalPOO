...
import br.edu.escolhas.TipoCalculoTetraedro;
 ...
 * @author Andre
 */
public class DadosAreaTotalTetraedro extends javax.swing.JFrame {

    /**
     * Creates new form DadosEsfera
     */
    public DadosAreaTotalTetraedro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(ArestaBaseText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 300, -1));
        ...
        getContentPane().add(AreaTotalLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 100, 40));
        getContentPane().add(AreaTotalText, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, 300, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/TetraedroAreaTotalDados.png"))); // NOI18N
    ...
    private void CalculeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculeButtonActionPerformed
        ...
        if ((((Double.parseDouble(ArestaBaseText.getText() ))) > 0)) { 
            Tetraedro tetra = new Tetraedro();
            tetra.setArestaBase(Double.parseDouble(ArestaBaseText.getText()));
            tetra.calcAreaTotal();
            AreaTotalLabel.setVisible(true);
            AreaTotalText.setText(String.format("%.2f", tetra.getAreaTotal()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaTotalTetraedro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaTotalTetraedro().setVisible(true);
            }
        });
    }
