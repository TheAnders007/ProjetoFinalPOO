 ...
 * @author MANUELA
 */
public class DadosAreaRetangulo extends javax.swing.JFrame {

    /**
     * Creates new form DadosAreaParalelogramo
     */
    public DadosAreaRetangulo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(texto_b, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, -1));
        ...
        getContentPane().add(texto_al, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, -1, -1));
        ...
        getContentPane().add(caixa_area, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, 230, -1));
        ...
        getContentPane().add(BaseText, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 230, -1));
        ...
        getContentPane().add(AlturaText, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 230, -1));

        tela.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/telasimagens/RetanguloDados.png"))); // NOI18N
    ...
    private void botao_calcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_calcActionPerformed
        ...
        ret.setBase(Double.parseDouble(BaseText.getText()));
        ret.setAltura(Double.parseDouble(AlturaText.getText()));
        ret.CalcArea1();
        
        caixa_area.setVisible(true);
        texto_area.setVisible(true);
        caixa_area.setText(String.format("%.2f", ret.getArea()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DadosAreaRetangulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DadosAreaRetangulo().setVisible(true);
            }
        });
    }
