 ...
 * @author Alunos
 */
public class TipoCalculoCone extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoCone() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        CalculoPainel.add(RetornarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, 90, -1));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
      if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosAreaLateralCone dalc = new DadosAreaLateralCone();
          dalc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaTotalCone datc = new DadosAreaTotalCone();
          datc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 2){
          DadosVolumeCone dvc = new DadosVolumeCone();
          dvc.setVisible(true);
      }
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoCone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoCone().setVisible(true);
            }
        });
    }
