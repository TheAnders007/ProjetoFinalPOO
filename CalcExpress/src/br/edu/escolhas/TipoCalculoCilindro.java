 ...
 * @author Alunos
 */
public class TipoCalculoCilindro extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoCilindro() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        CalculoPainel.add(ProsseguirButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 110, -1));
        ...
        CalculoPainel.add(RetornarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 90, -1));

        CaixaDeCalculo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        CaixaDeCalculo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Área Total", "Área Lateral", "Volume" }));
        ...
        CalculoPainel.add(CalculoFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, -1, 380));
        ...
        setSize(new java.awt.Dimension(715, 428));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
      if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosAreaLateralCilindro dalc = new DadosAreaLateralCilindro();
          dalc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaTotalCilindro datc = new DadosAreaTotalCilindro();
          datc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 2){
          DadosVolumeCilindro dvc = new DadosVolumeCilindro();
          dvc.setVisible(true);
      }
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoCilindro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoCilindro().setVisible(true);
            }
        });
    }
