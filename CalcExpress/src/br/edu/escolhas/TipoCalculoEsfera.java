 ...
 * @author Alunos
 */
public class TipoCalculoEsfera extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoEsfera() {
        initComponents();   
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(715, 440));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
      if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaEsfera dae = new DadosAreaEsfera();
          dae.setVisible(true);
      }
      if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosVolumeEsfera dve = new DadosVolumeEsfera();
          dve.setVisible(true);
      }
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoEsfera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoEsfera().setVisible(true);
            }
        });
    }
