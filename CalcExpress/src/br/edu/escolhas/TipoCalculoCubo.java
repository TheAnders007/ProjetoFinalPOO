 ...
 * @author Alunos
 */
public class TipoCalculoCubo extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoCubo() {
        initComponents();   
    ...
    private void initComponents() {
        ...
        CalculoPainel.add(ProsseguirButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 340, 120, -1));
        ...
        CalculoPainel.add(CalculoFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -6, -1, 380));
        ...
        setSize(new java.awt.Dimension(715, 438));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
      if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosAreaLateralCubo dalc = new DadosAreaLateralCubo();
          dalc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaTotalCubo datc = new DadosAreaTotalCubo();
          datc.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 2){
          DadosVolumeCubo dvc = new DadosVolumeCubo();
          dvc.setVisible(true);
      }
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoCubo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoCubo().setVisible(true);
            }
        });
    }
