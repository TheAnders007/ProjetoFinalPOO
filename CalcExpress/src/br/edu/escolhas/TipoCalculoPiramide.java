 ...
 * @author Alunos
 */
public class TipoCalculoPiramide extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoPiramide() {
        initComponents();   
    ...
    private void initComponents() {
        ...
        CalculoPainel.add(CalculoFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -16, -1, 400));
        ...
        setSize(new java.awt.Dimension(715, 436));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
      if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaTotalPiramide datp = new DadosAreaTotalPiramide();
          datp.setVisible(true);
      }
      else if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosVolumePiramide dvp = new DadosVolumePiramide();
          dvp.setVisible(true);
      }
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoPiramide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoPiramide().setVisible(true);
            }
        });
    }
