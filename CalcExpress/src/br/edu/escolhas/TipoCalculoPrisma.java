 ...
 * @author Alunos
 */
public class TipoCalculoPrisma extends javax.swing.JFrame {

    /**
     * Creates new form TipoCalculo
     */
    public TipoCalculoPrisma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        CaixaDeCalculo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Área Total", "Área Lateral", "Área da Base", "Área da Face", "Volume" }));
    ...
    private void ProsseguirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProsseguirButtonActionPerformed
       if (CaixaDeCalculo.getSelectedIndex() == 1){
          DadosAreaLateralPrisma dalp = new DadosAreaLateralPrisma();
          dalp.setVisible(true);
       }
       else if (CaixaDeCalculo.getSelectedIndex() == 0){
          DadosAreaTotalPrisma datp = new DadosAreaTotalPrisma();
          datp.setVisible(true);
       }
       else if (CaixaDeCalculo.getSelectedIndex() == 2){
          DadosAreaBasePrisma dabp = new DadosAreaBasePrisma();
          dabp.setVisible(true);
       }
       else if (CaixaDeCalculo.getSelectedIndex() == 3){
          DadosAreaFacePrisma dafp = new DadosAreaFacePrisma();
          dafp.setVisible(true);
       }
       else if (CaixaDeCalculo.getSelectedIndex() == 4){
          DadosVolumePrisma dvp = new DadosVolumePrisma();
          dvp.setVisible(true);
       }
       this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCalculoPrisma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCalculoPrisma().setVisible(true);
            }
        });
    }
